...
import com.example.cmmessenger.databinding.ActivitySettingBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Picasso.get().load(profile).into(binding.settingprofile);
            }
        ...
        binding.donebutt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                progressDialog.show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 10) {
            if (data != null) {
                ...
                binding.settingprofile.setImageURI(setImageUri);
            }
        }
